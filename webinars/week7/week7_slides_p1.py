...
#
ser3 = ser2.loc['2020-01-10':'2020-01-13']
print(ser3)
#
# should return:
#
...
res = ser.iloc[start:end] #return nothing
# <example>
# res = ser.iloc[start:end:-1] #return series from bottom to upside
# </example>
printit(res, f"ser.iloc[{start}:{end}]")
...
rlabel = '2020-01-02'
clabel = 'close' #column name you want to select
